...
def run_kfold_training(X, y, tokenizer, n_splits=5):
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(X, y)):
        ...
        model = RobertaForSequenceClassification.from_pretrained('roberta-base', num_labels=4, device_map="auto")
...
def main():
    ...
    df = prepare_data('data/fine_tuning/task2_fullscale_finetune.csv')
